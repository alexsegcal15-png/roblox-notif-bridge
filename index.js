...
// REEMPLAZA CON TU API KEY Y TU ID
...
const UNIVERSE_ID = 77355994785596; // <--- USANDO TU OTRO ID

app.post('/enviar', async (req, res) => {
    const { userId } = req.body;
    
    if (!userId) {
        console.error("Error: No se recibió userId");
    ...
    try {
        ...
        // Si sale el error vacío, Roblox sigue rechazando la llave por permisos
